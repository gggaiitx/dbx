export default {
  ...
  grid: {
    ...
    numericColumnAlign: "Numeric column alignment",
  ...
  settings: {
    ...
    numericColumnRightAlign: "Right-align numeric columns",
    numericColumnRightAlignDescription: "Right-align numeric columns (INTEGER, DECIMAL, FLOAT, MONEY, etc.) in query results for easier magnitude comparison. Text, date, and binary columns stay left-aligned.",
