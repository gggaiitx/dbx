...
export default withEnglishFallback({
  ...
  grid: {
    ...
    numericColumnAlign: "Alineación de columnas numéricas",
    numericColumnAlignLeft: "Izquierda",
    numericColumnAlignRight: "Derecha",
  ...
  settings: {
    ...
    numericColumnRightAlign: "Alinear a la derecha las columnas numéricas",
    numericColumnRightAlignDescription: "Alinea a la derecha las columnas numéricas (INTEGER, DECIMAL, FLOAT, MONEY, etc.) en los resultados de consulta para comparar magnitudes fácilmente. Las columnas de texto, fecha y binarias siguen alineadas a la izquierda.",
