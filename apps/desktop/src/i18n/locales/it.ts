...
export default withEnglishFallback({
  ...
  grid: {
    ...
    numericColumnAlign: "Allineamento colonne numeriche",
    numericColumnAlignLeft: "Sinistra",
    numericColumnAlignRight: "Destra",
  ...
  settings: {
    ...
    numericColumnRightAlign: "Allinea a destra le colonne numeriche",
    numericColumnRightAlignDescription: "Allinea a destra le colonne numeriche (INTEGER, DECIMAL, FLOAT, MONEY, ecc.) nei risultati delle query per confrontare più facilmente le grandezze. Le colonne di testo, data e binarie restano allineate a sinistra.",
