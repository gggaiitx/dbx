...
export default withEnglishFallback({
  ...
  settings: {
    ...
    numericColumnRightAlign: "数値列を右揃え",
    numericColumnRightAlignDescription: "クエリ結果の数値型列（INTEGER、DECIMAL、FLOAT、MONEY など）を右揃えで表示し、桁の比較を容易にします。テキスト・日付・バイナリ列は左揃えのままです。",
