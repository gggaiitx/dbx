...
export default withEnglishFallback({
  ...
  grid: {
    ...
    numericColumnAlign: "數值欄位對齊",
    numericColumnAlignLeft: "靠左",
    numericColumnAlignRight: "靠右",
  ...
  settings: {
    ...
    numericColumnRightAlign: "數值欄位靠右對齊",
    numericColumnRightAlignDescription: "查詢結果中的數值類型欄位（INTEGER、DECIMAL、FLOAT、MONEY 等）靠右對齊顯示，便於快速比對量級。文字、日期、二進位等欄位保持靠左對齊。",
